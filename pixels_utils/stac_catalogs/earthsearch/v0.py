...
class STACMetaData:
    ...
    Example:
        >>> from pixels_utils.stac_catalogs.earthsearch.v0 import EarthSearchCollections, STAC_MetaData
        >>> c = STAC_MetaData(collection=EarthSearchCollections.sentinel_s2_l2a_cogs)
        >>> c.asset_names
        >>> c.asset_titles
        >>> c.df_assets
